...
{
    public class ItemUpdatePolicyTests
    {
        [Fact]
        public async Task given_valid_item_should_allow_deletion()
        {
            ...
            var canDelete = await _itemUpdatePolicy.CanUpdateAsync(item);
        ...
        public ItemUpdatePolicyTests()
        {
            _itemUpdatePolicy = new ItemUpdatePolicy();
        }
    }
}
